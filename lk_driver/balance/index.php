...
$query ="SELECT * FROM `order` join `users`  ON users.id_users=order.id_users WHERE users.id_users = (SELECT `id_users` FROM `users` WHERE `login` = '$login') AND `status`='Выполнено' ";
